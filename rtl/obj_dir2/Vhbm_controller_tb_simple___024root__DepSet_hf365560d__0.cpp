...
void Vhbm_controller_tb_simple___024root___eval_triggers__act(Vhbm_controller_tb_simple___024root* vlSelf) {
    ...
    // Body
    vlSelfRef.__VactTriggered.setBit(0U, ((IData)(vlSelfRef.hbm_controller_tb_simple__DOT__clk) 
                                          != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__hbm_controller_tb_simple__DOT__clk__1)));
    vlSelfRef.__VactTriggered.setBit(1U, ((IData)(vlSelfRef.hbm_controller_tb_simple__DOT__clk) 
                                          & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__hbm_controller_tb_simple__DOT__clk__1))));
    vlSelfRef.__VactTriggered.setBit(2U, ((~ (IData)(vlSelfRef.hbm_controller_tb_simple__DOT__rst_n)) 
                                          & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__hbm_controller_tb_simple__DOT__rst_n__0)));
    vlSelfRef.__Vtrigprevexpr___TOP__hbm_controller_tb_simple__DOT__clk__1 
