...
VL_ATTR_COLD void Vhbm_controller_tb_simple___024root___eval_static(Vhbm_controller_tb_simple___024root* vlSelf) {
    ...
    vlSelfRef.__Vtrigprevexpr___TOP__hbm_controller_tb_simple__DOT__clk__0 = 0U;
    vlSelfRef.__Vtrigprevexpr___TOP__hbm_controller_tb_simple__DOT__clk__1 = 0U;
...
VL_ATTR_COLD void Vhbm_controller_tb_simple___024root___eval_static__TOP(Vhbm_controller_tb_simple___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.hbm_controller_tb_simple__DOT__clk = 0U;
...
#endif
            VL_FATAL_MT("hbm_controller_tb_simple.sv", 8, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vhbm_controller_tb_simple___024root___dump_triggers__stl(Vhbm_controller_tb_simple___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        VL_DBG_MSGF("         'stl' region trigger index 1 is active: @([hybrid] hbm_controller_tb_simple.clk)\n");
    }
}
#endif  // VL_DEBUG

void Vhbm_controller_tb_simple___024root___act_sequent__TOP__0(Vhbm_controller_tb_simple___024root* vlSelf);
VL_ATTR_COLD void Vhbm_controller_tb_simple___024root___stl_sequent__TOP__1(Vhbm_controller_tb_simple___024root* vlSelf);
...
VL_ATTR_COLD void Vhbm_controller_tb_simple___024root___eval_stl(Vhbm_controller_tb_simple___024root* vlSelf) {
    ...
    // Body
    if ((2ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vhbm_controller_tb_simple___024root___act_sequent__TOP__0(vlSelf);
    }
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vhbm_controller_tb_simple___024root___stl_sequent__TOP__1(vlSelf);
    }
}
...
VL_ATTR_COLD void Vhbm_controller_tb_simple___024root___stl_sequent__TOP__1(Vhbm_controller_tb_simple___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhbm_controller_tb_simple___024root___stl_sequent__TOP__1\n"); );
    Vhbm_controller_tb_simple__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vhbm_controller_tb_simple___024root___dump_triggers__act(Vhbm_controller_tb_simple___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([hybrid] hbm_controller_tb_simple.clk)\n");
    }
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge hbm_controller_tb_simple.clk)\n");
    }
    if ((4ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @(negedge hbm_controller_tb_simple.rst_n)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vhbm_controller_tb_simple___024root___dump_triggers__nba(Vhbm_controller_tb_simple___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([hybrid] hbm_controller_tb_simple.clk)\n");
    }
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge hbm_controller_tb_simple.clk)\n");
    }
    if ((4ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @(negedge hbm_controller_tb_simple.rst_n)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vhbm_controller_tb_simple___024root___ctor_var_reset(Vhbm_controller_tb_simple___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->hbm_controller_tb_simple__DOT__clk = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtrigprevexpr___TOP__hbm_controller_tb_simple__DOT__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__VstlDidInit = 0;
    vlSelf->__Vtrigprevexpr___TOP__hbm_controller_tb_simple__DOT__clk__1 = VL_RAND_RESET_I(1);
