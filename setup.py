...
setup(
    ...
    url="https://github.com/example/hbm-system",
    project_urls={
        "Documentation": "https://github.com/example/hbm-system/docs",
        "Source": "https://github.com/example/hbm-system",
        "Tracker": "https://github.com/example/hbm-system/issues",
    },
    python_requires=">=3.8",
    classifiers=[
